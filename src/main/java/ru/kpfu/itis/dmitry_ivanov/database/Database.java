...
public class Database {
    ...
    public void addUser(String login, String password, String mail) {
        connect();
        try {
           PreparedStatement statement = connection.prepareStatement("insert into users(login, password, mail) values(?,?,?);");
    ...
    public void addProduct(Product product){
        connect();
        try {
          PreparedStatement  statement = connection.prepareStatement("insert into products(name, processor,diagonal,display_type," +
    ...
    public int getUserId(String name){
        ...
        connect();
        try {
          PreparedStatement  statement = connection.prepareStatement("select user_id from users where login=?;");
    ...
    public String getUserName(String id){
        ...
        connect();
        try {
          PreparedStatement  statement = connection.prepareStatement("select login from users where user_id=?;");
            statement.setInt(1,Integer.parseInt(id));
            resultSet=statement.executeQuery();
            while (resultSet.next()){
    ...
    public void addComment(Comment comment){
        ...
        try {
         PreparedStatement   statement = connection.prepareStatement("insert into comments values(?,?,?);");
            ...
            statement.setInt(2,getUserId(comment.user));
